...
class Problem0003Test {
  ...
  @Test
  void problem0003BorderCaseTest() {

    Long answer = null;
    Long top = 1L;
    Long solutionFound = Problem0003.problem0003(top);

    assertEquals(answer, solutionFound, String.format(OUTPUT_MESSAGE, answer));
  }

  @Test
  void problem0003ShortCaseTest() {
