...
class DivisorsTest {
  ...
  void instanceCaseTest() {
    ...
    assertInstanceOf(
        Divisors.class, classUnderTest, String.format("Must be an instance of %s", Divisors.class));
  }

  @Test
  void listOfDivisorsOfNumberBorderCaseTest() {

    DivisorsOfNumberTestCase[] testCases = {new DivisorsOfNumberTestCase(1L, new Long[] {1L}, 0L)};
  ...
  @Test
  void listOfDivisorsOfNumberTest() {
