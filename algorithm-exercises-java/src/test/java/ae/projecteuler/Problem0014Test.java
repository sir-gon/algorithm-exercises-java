...
class Problem0014Test {
  ...
  @Test
  void problem0014() throws Exception {
    ...
    assertEquals(answer, solutionFound, String.format("Problem 0014 answer must be: %d", answer));
  }

  @Test
  void problem0014borderCase() {
  ...
  @Test
  void problem0014WrongParameterCase() {
