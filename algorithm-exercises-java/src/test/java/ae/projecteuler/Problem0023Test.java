...
class Problem0023Test {
  ...
  void problem0023smallCase1(
      int inputUnderLimit, int inputSuperLimit, int answer, String testCase) {
  ...
  void problem0023fullCase() {
    ...
    assertEquals(answer, solutionFound, String.format("Problem 0023 answer must be: %d", answer));
  }
}
