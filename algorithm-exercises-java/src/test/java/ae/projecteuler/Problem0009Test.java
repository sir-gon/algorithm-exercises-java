...
class Problem0009Test {
  ...
  @Test
  void problem0009EmptyTest() {

    Integer expectedSolution = null;
    Integer inputLimit = 1;
    Integer solutionFound = Problem0009.problem0009(inputLimit);

    assertEquals(expectedSolution, solutionFound, String.format(OUTPUT_MESSAGE, expectedSolution));
  }

  @Test
  void problem0009EdgeTest() {
